...
#define ASSERT(cond) ((void)((cond) ? 0 : (printf("%s:%d ASSERT(%s) failed", __FILE__, __LINE__, #cond))))
...
template<int n = 2, class V = float> class Vector 
  : public VectorData<n, V>
{
  public:
    ...
    {
      //cast to VectorData* first to go to start of the right base class 
      return ((V*)((VectorData<n, V>*)this))[i];
    }
